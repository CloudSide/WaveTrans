...
#import "VdiskError__.h"

//NSString *kVdiskErrorDomain = @"VdiskSDKErrorDomain";


kVdiskErrorLevel VdiskErrorParseErrorLevel__(NSError *error) {

    NSInteger errorCode = VdiskErrorParseErrorCode__(error);
...
NSUInteger VdiskErrorParseErrorCode__(NSError *error) {
...
NSString *VdiskErrorMessageWithCode__(NSError *error) {
