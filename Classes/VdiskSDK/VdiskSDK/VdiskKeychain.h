...
extern NSString *const kVdiskKeychainErrorDomain;

/** Account name. */
extern NSString *const kVdiskKeychainAccountKey;
 ...
 */
extern NSString *const kVdiskKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kVdiskKeychainClassKey;

/** Item description. */
extern NSString *const kVdiskKeychainDescriptionKey;

/** Item label. */
extern NSString *const kVdiskKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kVdiskKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kVdiskKeychainWhereKey;
...
/**
 ...
 VdiskKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface VdiskKeychain : NSObject
...
/**
 ...
 See the `NSString` constants declared in VdiskKeychain.h for a list of keys that can be used when accessing the
